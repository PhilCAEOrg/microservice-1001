 ...
 * 1001 - Test Class
 *
 * This class provides a basic testing framework for the microservice 1001. It was
...
public class ResTest {
  ...
  public void testme() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/me", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testme': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
